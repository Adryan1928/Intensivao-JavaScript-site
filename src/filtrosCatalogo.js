...
function esconderMasculinos() {
    exibirTodos()
    const produtosMasculinos = Array.from(catologoProdutos.getElementsByClassName('masculino'))
...
function esconderFemininos() {
    exibirTodos()
    const produtosFemininos = Array.from(catologoProdutos.getElementsByClassName('feminino'))
